...
- "Uploads without metadata" disabled- and both upload tables combined (All uploads now require metadata)
- Upload status table only shows 100 most recent uploads
- Fixed some bugs with metadata selection
